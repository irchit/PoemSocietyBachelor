...
def get_sentiment_fr(text):
    candidate_labels = ["espoir", "amour", "tristesse", "joie", "peur", "regret", "solitude", "calme", "admiration", "nostalgie"]
...
def get_keywords_fr(text, max_keywords=10):
