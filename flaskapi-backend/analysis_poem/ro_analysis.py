...
def get_sentiment_ro(text):
    candidate_labels = ["speranță", "iubire", "tristețe", "bucurie", "teamă", "regret", "singurătate", "liniște", "admirație", "nostalgie"]
...
def get_keywords_ro(text, max_keywords=10):
