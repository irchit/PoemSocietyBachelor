...
def get_sentiment_es(text):
    candidate_labels = ["esperanza", "amor", "tristeza", "alegría", "miedo", "arrepentimiento", "soledad", "calma", "admiración", "nostalgia"]
...
def get_keywords_es(text, max_keywords=10):
